...
const RATED__API =
  "https://api.themoviedb.org/3/trending/all/day?api_key=40b98d136e6b6d3ae87106bc05050eb1";
...
const Movies = () => {
  ...
  return (
    <>
      {ratedMovies && <GetMovie API={RATED__API} label="Top Rated Movies" />}
      {ratedTV && <GetMovie API={RATED__TV} label="Top Rated TV Shows" />}
      {popularMovies && <GetMovie API={POPULAR__API} label="Popular Movies" />}
